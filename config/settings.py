...
from dotenv import load_dotenv #env파일을 통한 데이터베이스 안전연결

# Build paths inside the project like this: BASE_DIR / 'subdir'.
BASE_DIR = Path(__file__).resolve().parent.parent

load_dotenv(BASE_DIR / '.env') #env파일 연결
...
SECRET_KEY = 'django-insecure-nly7j$$72qvixdf$5o()i3_q7qm%i!s)z#^^w+kpxmt!tj%f1b'
...
DATABASES = { #mysql 연결에 적합한 데이터베이스 코드로 설정
    'default': {
        'ENGINE': 'django.db.backends.mysql',
        'NAME': os.getenv('DB_NAME'),
        'USER': os.getenv('DB_USER'),
        'PASSWORD': os.getenv('DB_PASSWORD'), #이를 통해 github상 비밀번호 노출을 막음
